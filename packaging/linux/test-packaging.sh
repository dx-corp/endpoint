...
for script in build-package.sh install.sh merlin-launcher.sh uninstall.sh; do
...
for path in install.sh uninstall.sh payload/usr/local/libexec/merlin/merlin payload/usr/local/libexec/merlin/merlin-ebpf.o payload/usr/local/libexec/merlin/merlin-launcher payload/usr/lib/systemd/system/merlin.service payload/etc/merlin/rules.yaml payload/etc/merlin/merlin.env.example; do
